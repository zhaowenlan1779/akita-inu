 ...
 *
 *  Modifications by Pengfei Zhu for general complex types
 *
...
private:
    ...
    void kf_bfly3(cpx_t* Fout, const std::size_t fstride, const std::size_t m) const {
        ...
        do {
            ...
            Fout[m] = Fout[0] - scratch[3] / scalar_t(2);
            scratch[0] *= epi3.imag();
    ...
    void kf_bfly5(cpx_t* const Fout, const std::size_t fstride, const std::size_t m) const {
        ...
        for (std::size_t u = 0; u < m; ++u) {
            ...
            *Fout0 += scratch[8];
            ...
            scratch[5] =
                scratch[0] + cpx_t(scratch[7].real() * ya.real() + scratch[8].real() * yb.real(),
                                   scratch[7].imag() * ya.real() + scratch[8].imag() * yb.real());

            scratch[6] = cpx_t(scratch[10].imag() * ya.imag() + scratch[9].imag() * yb.imag(),
            ...
            *Fout4 = scratch[5] + scratch[6];
            ...
            scratch[11] =
                scratch[0] + cpx_t(scratch[7].real() * yb.real() + scratch[8].real() * ya.real(),
                                   scratch[7].imag() * yb.real() + scratch[8].imag() * ya.real());

            scratch[12] = cpx_t(-scratch[10].imag() * yb.imag() + scratch[9].imag() * ya.imag(),
